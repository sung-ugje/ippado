package egovframework.ippado.main.web;
...
public class MainController {
	 ...
	 */
	@RequestMapping(value = "/main/forwardPage.do")
     ...
     * @exception Exception
     */
    @RequestMapping(value="/main/MainMenuHead.do")
    public String selectMainMenuHead(
        ...
        return "main/inc/IncTopnav"; // 내부업무의 상단메뉴 화면
    }
     ...
     * @exception Exception
     */
    @RequestMapping(value="/main/MainMenuLeft.do")
