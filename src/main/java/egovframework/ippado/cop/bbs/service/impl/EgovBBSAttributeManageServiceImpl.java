...
import egovframework.ippado.cop.bbs.service.BoardMaster;
import egovframework.ippado.cop.bbs.service.BoardMasterVO;
import egovframework.ippado.cop.bbs.service.EgovBBSAttributeManageService;
import egovframework.ippado.cop.com.service.BoardUseInf;
import egovframework.ippado.cop.com.service.EgovUserInfManageService;
import egovframework.ippado.cop.com.service.UserInfVO;
import egovframework.ippado.cop.com.service.impl.BBSUseInfoManageDAO;
...
public class EgovBBSAttributeManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSAttributeManageService {
     ...
     * 등록된 게시판 속성정보를 삭제한다.
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSAttributeManageService#deleteBBSMasterInf(egovframework.ippado.cop.bbs.brd.service.BoardMaster)
     */
     ...
     * 신규 게시판 속성정보를 생성한다.
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSAttributeManageService#insertBBSMastetInf(egovframework.ippado.cop.bbs.brd.service.BoardMaster)
     */
     ...
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSAttributeManageService#selectAllBBSMasteInf(egovframework.ippado.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSAttributeManageService#selectBBSMasterInf(egovframework.ippado.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     * 게시판 속성 정보의 목록을 조회 한다.
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSAttributeManageService#selectBBSMasterInfs(egovframework.ippado.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     * 게시판 속성정보를 수정한다.
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSAttributeManageService#updateBBSMasterInf(egovframework.ippado.cop.bbs.brd.service.BoardMaster)
     */
     ...
     * 템플릿의 유효여부를 점검한다.
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSAttributeManageService#validateTemplate(egovframework.ippado.cop.bbs.brd.service.BoardMasterVO)
     */
