...
public class BBSLoneMasterDAO extends EgovComAbstractDAO {
	...
	update("BBSLoneMaster.deleteMaster", boardMaster);
    }
	...
	return (int) insert("BBSLoneMaster.insertMaster", boardMaster);
    }
	...
	return (BoardMasterVO)select("BBSLoneMaster.selectMaster", vo);
    }
    ...
    public List<BoardMasterVO> selectMasterList(BoardMasterVO vo) throws Exception {
    	return selectList("BBSLoneMaster.selectMasterList", vo);
    }
	...
	return (Integer)select("BBSLoneMaster.selectMasterListCnt", vo);
    }
	...
	update("BBSLoneMaster.updateMaster", boardMaster);
    }
}
