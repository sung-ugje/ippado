...
import egovframework.ippado.cop.bbs.service.EgovBBSManageService;
import egovframework.ippado.utl.fcc.service.EgovDateUtil;
...
public class EgovBBSManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSManageService {
     ...
     * 게시물 한 건을 삭제 한다.
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSManageService#deleteBoardArticle(egovframework.ippado.cop.bbs.brd.service.Board)
     */
     ...
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSManageService#insertBoardArticle(egovframework.ippado.cop.bbs.brd.service.Board)
     */
     ...
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSManageService#selectBoardArticle(egovframework.ippado.cop.bbs.brd.service.BoardVO)
     */
     ...
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSManageService#selectBoardArticles(egovframework.ippado.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 게시물 한 건의 내용을 수정 한다.
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSManageService#updateBoardArticle(egovframework.ippado.cop.bbs.brd.service.Board)
     */
     ...
     * 방명록 내용을 삭제 한다.
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSManageService#deleteGuestList(egovframework.ippado.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 방명록에 대한 목록을 조회 한다.
     *
     * @see egovframework.ippado.cop.bbs.brd.service.EgovBBSManageService#selectGuestList(egovframework.ippado.cop.bbs.brd.service.BoardVO)
     */
