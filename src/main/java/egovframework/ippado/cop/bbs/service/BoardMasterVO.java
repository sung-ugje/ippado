package egovframework.ippado.cop.bbs.service;
...
public class BoardMasterVO extends BoardMaster implements Serializable {
    ...
    private int posblAtchFileSize = 0;
	...
	/**
	 * @return 항목 {@link #posblAtchFileNumber}의 값을 반환한다.
	 */
	...
	/**
	 * @param posblAtchFileNumber 항목 {@link #posblAtchFileNumber}의 값을 지정한다.
	 */
	...
	/**
	 * @return 항목 {@link #posblAtchFileSize}의 값을 반환한다.
	 */
	public int getPosblAtchFileSize() {
		return posblAtchFileSize;
	}

	/**
	 * @param posblAtchFileSize 항목 {@link #posblAtchFileSize}의 값을 지정한다.
	 */
	public void setPosblAtchFileSize(int posblAtchFileSize) {
