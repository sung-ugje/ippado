...
public class BBSAttributeManageDAO extends EgovComAbstractDAO {
	...
	update("BBSAttributeManage.deleteBBSMasterInf", boardMaster);
    }
	...
	return (int)insert("BBSAttributeManage.insertBBSMasterInf", boardMaster);
    }
	...
	return (BoardMasterVO)select("BBSAttributeManage.selectBBSMasterInf", vo);
    }
	...
	return selectList("BBSAttributeManage.selectBBSMasterInfs", vo);
    }
	...
	return (Integer)select("BBSAttributeManage.selectBBSMasterInfsCnt", vo);
    }
	...
	update("BBSAttributeManage.updateBBSMasterInf", boardMaster);
    }
	...
	return  selectList("BBSAttributeManage.selectAllBBSMaster", vo);
    }
	...
	return  selectList("BBSAttributeManage.selectBdMstrListByTrget", vo);
    }
	...
	return (Integer)select("BBSAttributeManage.selectBdMstrListCntByTrget", vo);
    }
	...
	return  selectList("BBSAttributeManage.selectAllBdMstrByTrget", vo);
    }
	...
	return  selectList("BBSAttributeManage.selectNotUsedBdMstrList", vo);
    }
	...
	return (Integer)select("BBSAttributeManage.selectNotUsedBdMstrListCnt", vo);
    }
}
