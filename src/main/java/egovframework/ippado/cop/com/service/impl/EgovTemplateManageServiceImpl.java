...
import egovframework.ippado.cop.com.service.EgovTemplateManageService;
import egovframework.ippado.cop.com.service.TemplateInf;
import egovframework.ippado.cop.com.service.TemplateInfVO;
...
public class EgovTemplateManageServiceImpl extends EgovAbstractServiceImpl implements EgovTemplateManageService {
     ...
     * 템플릿 정보를 삭제한다.
     * 
     * @see egovframework.ippado.cop.bbs.com.service.EgovTemplateManageService#deleteTemplateInf(egovframework.ippado.cop.bbs.com.service.TemplateInf)
     */
     ...
     * 템플릿 정보를 등록한다.
     * 
     * @see egovframework.ippado.cop.bbs.com.service.EgovTemplateManageService#insertTemplateInf(egovframework.ippado.cop.bbs.com.service.TemplateInf)
     */
     ...
     * 템플릿에 대한 상세정보를 조회한다.
     * 
     * @see egovframework.ippado.cop.bbs.com.service.EgovTemplateManageService#selectTemplateInf(egovframework.ippado.cop.bbs.com.service.TemplateInfVO)
     */
     ...
     * 템플릿에 대한 목록를 조회한다.
     * 
     * @see egovframework.ippado.cop.bbs.com.service.EgovTemplateManageService#selectTemplateInfs(egovframework.ippado.cop.bbs.com.service.TemplateInfVO)
     */
     ...
     * 
     * @see egovframework.ippado.cop.bbs.com.service.EgovTemplateManageService#selectTemplatePreview(egovframework.ippado.cop.bbs.com.service.TemplateInfVO)
     */
     ...
     * 템플릿 정보를 수정한다.
     * 
     * @see egovframework.ippado.cop.bbs.com.service.EgovTemplateManageService#updateTemplateInf(egovframework.ippado.cop.bbs.com.service.TemplateInf)
     */
     ...
     * 템플릿 구분에 따른 목록을 조회한다.
     * 
     * @see egovframework.ippado.cop.bbs.com.service.EgovTemplateManageService#selectAllTemplateInfs(egovframework.ippado.cop.bbs.com.service.TemplateInfVO)
     */
