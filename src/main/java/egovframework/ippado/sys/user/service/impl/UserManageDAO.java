...
public class UserManageDAO extends EgovComAbstractDAO{
    ...
    public int checkIdDplct(String checkId){
        return (Integer)select("userManage.checkIdDplct_S", checkId);
    }
    ...
    public void deleteUser(String delId){
        delete("userManage.deleteUser_S", delId);
    }
     ...
     */
    public Integer insertUser(UserManageVO userManageVO){
        return (Integer) insert("userManage.insertUser_S", userManageVO);
    }
    ...
    public UserManageVO selectUser(String uniqId){
        return (UserManageVO) select("userManage.selectUser_S", uniqId);
    }
	...
	public List<?> selectUserList(UserDefaultVO userSearchVO){
        return selectList("userManage.selectUserList_S", userSearchVO);
    }
    ...
    public int selectUserListTotCnt(UserDefaultVO userSearchVO) {
        return (Integer)select("userManage.selectUserListTotCnt_S", userSearchVO);
    }
    ...
    public void updateUser(UserManageVO userManageVO){
        update("userManage.updateUser_S",userManageVO);
    }
     ...
     */
    public Integer insertUserHistory(UserManageVO userManageVO){
    	return (Integer)insert("userManage.insertUserHistory_S", userManageVO);
    }
    ...
    public void updatePassword(UserManageVO passVO) {
        update("userManage.updatePassword_S", passVO);
    }
    ...
    public UserManageVO selectPassword(UserManageVO userManageVO){
    	return (UserManageVO) select("userManage.selectPassword_S", userManageVO);
    }
