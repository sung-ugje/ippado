...
import egovframework.ippado.sys.user.service.LoginService;
import egovframework.ippado.utl.sim.service.EgovClntInfo;
...
public class LoginController {
	...
	LoginPolicyService egovLoginPolicyService;
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sys/user/loginUsr.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sys/user/actionSecurityLogin.do")
	public String actionSecurityLogin(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletResponse response, HttpServletRequest request, ModelMap model) throws Exception {
		...
		if (resultVO != null && resultVO.getId() != null && !resultVO.getId().equals("") && loginPolicyYn) {
			...
			return "forward:/sys/user/actionMain.do"; // 성공 시 페이지.. (redirect 불가)
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sys/user/actionMain.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sys/user/actionLogout.do")
