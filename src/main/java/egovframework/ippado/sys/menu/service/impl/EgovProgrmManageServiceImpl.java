...
public class EgovProgrmManageServiceImpl extends EgovAbstractServiceImpl implements ProgrmManageService {
	...
	public void insertProgrm(ProgrmManageVO vo) throws Exception {
		String programId =  programIdGnrService.getNextStringId();
		vo.setProgrmId(programId);
