...
function fnDeleteUser() {
    ...
    if(checkedIds.length > 0) {
        ...
        if(confirm("<spring:message code="common.delete.msg" />")){
            ...
            document.listForm.action = "<c:url value='/sys/user/UserDelete.do'/>";
...
function fnSelectUser(id) {
    ...
    document.listForm.action = "<c:url value='/sys/user/UserSelectUpdtView.do'/>";
    document.listForm.submit();
      
}
function fnAddUserView() {
    document.listForm.action = "<c:url value='/sys/user/UserInsertView.do'/>";
    document.listForm.submit();
}
function fnLinkPage(pageNo){
    document.listForm.pageIndex.value = pageNo;
    document.listForm.action = "<c:url value='/sys/user/UserManage.do'/>";
    document.listForm.submit();
}
function fnSearch(){
                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a href="<c:url value='/sys/user/UserManage.do'/>" onclick="javascript:fnSearch(); return false;"><img src="<c:url value='/images/img_search.gif' />" alt="search" />조회 </a>
				                        <a href="#LINK" onclick="javascript:fnDeleteUser(); return false;"><spring:message code="button.delete" /></a>
				                        <a href="<c:url value='/sys/user/UserManage.do'/>"><spring:message code="button.list" /></a>
				                        <a href="<c:url value='/sys/user/UserInsertView.do'/>" onclick="fnAddUserView(); return false;"><spring:message code="button.create" /></a>
                                    </div>                              
                                </li>
                            </ul>           
                        </div>          
                    ...
                    <!-- loop 시작 -->                                
                      <tr>
	                    ...
	                    <td nowrap style="cursor:pointer;cursor:hand" >
	                        <span class="link"><a href="<c:url value='/sys/user/UserSelectUpdtView.do'/>?selectedId=<c:out value="${result.uniqId}"/>"  onclick="javascript:fnSelectUser('<c:out value="${result.userTy}"/>:<c:out value="${result.uniqId}"/>'); return false;"><c:out value="${result.userId}"/></a></span>
	                    </td>
