...
function fncUserAbsnceInsert() {
    ...
    var varFrom = document.getElementById("userAbsnce");
    varFrom.action = "<c:url value='/sys/user/addUserAbsnce.do'/>";
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form:form commandName="userAbsnce" action="${pageContext.request.contextPath}/sys/user/addUserAbsnce.do" method="post"> 
