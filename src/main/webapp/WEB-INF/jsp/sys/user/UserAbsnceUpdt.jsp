...
function fncSelectUserAbsnceList() {
    ...
    varFrom.action = "<c:url value='/sys/user/UserAbsnceList.do'/>";
    varFrom.submit();       
}
...
function fncUserAbsnceUpdate() {
    ...
    var varFrom = document.getElementById("userAbsnce");
    varFrom.action = "<c:url value='/sys/user/updtUserAbsnce.do'/>";
...
function fncUserAbsnceDelete() {
    var varFrom = document.getElementById("userAbsnce");
    varFrom.action = "<c:url value='/sys/user/removeUserAbsnce.do'/>";
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form:form commandName="userAbsnce" action="${pageContext.request.contextPath}/sys/user/updtUserAbsnce.do" method="post">  
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <tr> 
                          ...
                          <td width="10"></td>
                          <td>
                            <a href="<c:url value='/sys/user/removeUserAbsnce.do'/>?userId=<c:out value='${userAbsnceVO.userId}'/>&amp;selAbsnceAt=<c:out value='${userAbsnceVO.selAbsnceAt}'/>" onclick="fncUserAbsnceDelete(); return false;"><spring:message code="button.delete" /></a> 
                          </td>
                          <td width="10"></td>
                          <td>
                            <a href="<c:url value='/sys/user/UserAbsnceList.do'/>?pageIndex=<c:out value='${userAbsnceVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${userAbsnceVO.searchKeyword}"/>&amp;searchCondition=1&amp;selAbsnceAt=<c:out value="${userAbsnceVO.selAbsnceAt}"/>" onclick="fncSelectUserAbsnceList(); return false;"><spring:message code="button.list" /></a> 
                          </td>
                        </tr>
                        </table>
                    </div>
