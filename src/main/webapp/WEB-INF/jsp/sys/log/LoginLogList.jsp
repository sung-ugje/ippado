	...
	******************************************************** */
	...
	function fn_egov_select_loginLog(pageNo){
	    ...
	    if(fromDate > toDate) {
	        ...
	        document.frm.action = "<c:url value='/sys/log/LoginLogList.do'/>";
	        document.frm.submit();
	    }
	}
   
    function fn_egov_inqire_loginLog(logId){
        var url = "<c:url value ='/sys/log/InqireLoginLog.do?logId='/>" + logId;
...
<div id="wrap">
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            <!-- 현재위치 네비게이션 시작 -->
            <div id="content">
            <form name="frm" id="frm" action ="<c:url value='/sym/log/LoginLogList.do'/>" method="post">
                    ...
                    <div id="search_field_loc"><h2><strong>로그인 로그조회</strong></h2></div>
                        ...
                        <div class="sf_start">
                            <ul id="search_first_ul">
                                <li>발생일자
							          <input name="searchKeywordFrom" type="text" size="10" value="${searchVO.searchKeywordFrom}"  readOnly
							            onClick="javascript:fn_egov_NormalCalendar(document.frm, document.frm.searchKeywordFrom);" title="시작일자입력">
							          <a href="javascript:fn_egov_NormalCalendar(document.frm, document.frm.searchKeywordFrom);"
							          ...
							          ~
							          <input name="searchKeywordTo" type="text" size="10" value="${searchVO.searchKeywordTo}"  readOnly
							            onClick="javascript:fn_egov_NormalCalendar(document.frm, document.frm.searchKeywordTo);" title="종료일자입력">
							          <a href="javascript:fn_egov_NormalCalendar(document.frm, document.frm.searchKeywordTo);"
							            style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"
							            width="15" height="15"></a>
                                </li>
                            </ul>
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a href="<c:url value='/sym/log/LoginLogList.do'/>" onclick="javascript:fn_egov_select_loginLog('1'); return false;" >
