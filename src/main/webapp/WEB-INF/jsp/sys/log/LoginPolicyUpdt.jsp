...
function fncSelectLoginPolicyList() {
    ...
    varFrom.action = "<c:url value='/sys/log/LoginPolicyList.do'/>";
    varFrom.submit();       
}

function fncLoginPolicyUpdate() {
    var varFrom = document.getElementById("loginPolicy");
    varFrom.action = "<c:url value='/sys/log/updtLoginPolicy.do'/>";
...
function fncLoginPolicyDelete() {
    var varFrom = document.getElementById("loginPolicy");
    varFrom.action = "<c:url value='/sys/log/removeLoginPolicy.do'/>";
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form:form commandName="loginPolicy" method="post" action="${pageContext.request.contextPath}/sys/log/updtLoginPolicy.do">  
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" align="center">
	                        <tr> 
	                          ...
	                          <td width="10"></td>
	                          <td>
	                            <a href="<c:url value='/sys/log/removeLoginPolicy.do'/>?emplyrId=<c:out value='${loginPolicyVO.emplyrId}'/>" onclick="fncLoginPolicyDelete(); return false;"><spring:message code="button.delete" /></a>  
	                          </td>
	                          <td width="10"></td>
	                          <td>
	                            <a href="<c:url value='/sys/log/LoginPolicyList.do'/>?pageIndex=<c:out value='${loginPolicyVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${loginPolicyVO.searchKeyword}"/>&amp;searchCondition=1" onclick="fncSelectLoginPolicyList(); return false;"><spring:message code="button.list" /></a>  
	                          </td>
	                        </tr>
                        </table>
                    </div>
