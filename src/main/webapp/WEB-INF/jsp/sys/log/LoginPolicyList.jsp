<%--
  ...
  Description : LoginPolicyList 화면
...
function fncSelectLoginPolicyList(pageNo){
    ...
    document.listForm.action = "<c:url value='/sys/log/LoginPolicyList.do'/>";
    document.listForm.submit();
}

function fncSelectLoginPolicy(emplyrId) {
    document.listForm.emplyrId.value = emplyrId;
    document.listForm.action = "<c:url value='/sys/log/getLoginPolicy.do'/>";
    document.listForm.submit();
}
...
function fncAddLoginPolicyInsert() {
    ...
    if(fncInsertCheckId()) {
        document.listForm.action = "<c:url value='/sys/log/addLoginPolicyView.do'/>";
        document.listForm.submit();
    }
}
...
function fncLoginPolicyListDelete() {
    if(fncManageChecked()) {
        if(confirm("삭제하시겠습니까?")) {
            document.listForm.action = "<c:url value='/sys/log/removeLoginPolicyList.do'/>";
            document.listForm.submit();
        }
    }
}
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <div id="search_field">
                    ...
                    <form name="listForm" action="<c:url value='/sys/log/LoginPolicyList.do'/>" method="post">
                ...
                <div class="default_tablestyle">
                    ...
                    <!-- loop 시작 -->
                      <tr>
					    <td nowrap="nowrap">
					        <form name="item" method="post" action="<c:url value='/sys/log/getLoginPolicy.do'/>">
