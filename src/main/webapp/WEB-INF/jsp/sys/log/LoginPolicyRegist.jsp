...
function fncLoginPolicyInsert() {
    ...
    var varFrom = document.getElementById("loginPolicy");
    varFrom.action = "<c:url value='/sys/log/addLoginPolicy.do'/>";
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form:form commandName="loginPolicy" method="post" action="${pageContext.request.contextPath}/sys/log/addLoginPolicy.do"> 
