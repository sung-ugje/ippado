...
function fncSelectAuthorList() {
    ...
    varFrom.action = "<c:url value='/sys/author/AuthorList.do'/>";
    varFrom.submit();       
}
...
function fncAuthorInsert() {
    ...
    var varFrom = document.getElementById("authorManage");
    varFrom.action = "<c:url value='/sys/author/AuthorInsert.do'/>";
...
function fncAuthorUpdate() {
    var varFrom = document.getElementById("authorManage");
    varFrom.action = "<c:url value='/sys/author/AuthorUpdate.do'/>";
...
function fncAuthorDelete() {
    var varFrom = document.getElementById("authorManage");
    varFrom.action = "<c:url value='/sys/author/AuthorDelete.do'/>";
