<%--
  Class Name : AuthorMenu.jsp
  Description : 권한별메뉴 화면
...
<script language="javascript1.2" type="text/javaScript" src="<c:url value='/js/AuthorMenu.js'/>"></script>
<script language="javascript1.2" type="text/javaScript">
<!--
/* ********************************************************
 * 조회 함수
 ******************************************************** */
function selectAuthorMenuTmp() {
...
function fInsertAuthorMenu() {
    ...
    document.menuCreatManageForm.action = "<c:url value='/sys/author/AuthorMenuInsert.do'/>";
    document.menuCreatManageForm.submit(); 
}
/* ********************************************************
 * 메뉴사이트맵 생성 화면 호출
 ******************************************************** */
function fAuthorMenuSiteMap() {
    id = document.menuCreatManageForm.authorCode.value;
    window.open("<c:url value='/sys/author/AuthorMenuSiteMapSelect.do'/>?authorCode="+id,'Pop_SiteMap','scrollbars=yes, width=550, height=700');
}
...
<div id="wrap">
            ...
            <div id="content">
                ...
                <form name="menuCreatManageForm" action ="/sys/author/AuthorMenuSiteMapSelect.do" method="post">
                <input type="submit" id="invisible" class="invisible"/>
	                ...
	                <!-- 검색 필드 박스 시작 -->
	                <div id="search_field">
	                    <div id="search_field_loc"><h2><strong>권한별메뉴</strong></h2></div>
	                            ...
	                            <ul id="search_second_ul">
	                                <li>
	                                    <div class="buttons" style="float:right;">
	                                        <a href="#LINK" onclick="fInsertAuthorMenu(); return false;">권한별메뉴 저장</a>
	                                    </div>                              
	                                </li>
	                            </ul>           
	                        </div>          
	                ...
	                <div >
	                    <c:forEach var="result1" items="${list_menulist}" varStatus="status" >
                            <input type="hidden" name="tmp_menuNmVal" value="${result1.menuNo}|${result1.upperMenuId}|${result1.menuNm}|${result1.progrmFileNm}|${result1.chkYeoBu}|"></c:forEach>
