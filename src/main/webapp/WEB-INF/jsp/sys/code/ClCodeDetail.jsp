 ...
 ******************************************************** */
function fnList(){
    location.href = "<c:url value='/sys/code/ClCodeList.do'/>";
}
/* ********************************************************
 * 수정화면으로  바로가기
 ******************************************************** */
function fnModify(){
    ...
    varForm.action           = "<c:url value='/sys/code/ClCodeModify.do'/>";
...
function fnDelete(){
    if (confirm("<spring:message code="common.delete.msg" />")) {
        var varForm              = document.all["Form"];
        varForm.action           = "<c:url value='/sys/code/ClCodeRemove.do'/>";
        varForm.clCode.value     = "${result.clCode}";
        varForm.submit();
    }
}
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form name="Form" method="post" action="<c:url value='/sys/code/ClCodeModify.do'/>">
