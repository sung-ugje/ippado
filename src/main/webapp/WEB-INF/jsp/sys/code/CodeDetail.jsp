...
function fnModify(){
    ...
    varForm.action           = "<c:url value='/sys/code/CodeModify.do'/>";
...
function fnDelete(){
    if (confirm("<spring:message code='common.delete.msg'/>")) {
        var varForm              = document.all["Form"];
        varForm.action           = "<c:url value='/sys/code/CodeRemove.do'/>";
        varForm.codeId.value     = "${result.codeId}";
        varForm.submit();
    }
}
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form name="Form" method="post" action="<c:url value='/sys/code/CodeModify.do'/>">
