...
function linkPage(pageNo){
    ...
    document.listForm.action = "<c:url value='/sys/code/DetailCodeList.do'/>";
 ...
 ******************************************************** */
function fnRegist(){
    location.href = "<c:url value='/sys/code/DetailCodeRegist.do'/>";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
...
function fnDetail(codeId, code){
    ...
    varForm.action           = "<c:url value='/sys/code/DetailCodeDetail.do'/>";
...
<div id="wrap">
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            <!-- 현재위치 네비게이션 시작 -->
            <div id="content">
            <form name="listForm" action="<c:url value='/sys/code/DetailCodeList.do'/>" method="post">
