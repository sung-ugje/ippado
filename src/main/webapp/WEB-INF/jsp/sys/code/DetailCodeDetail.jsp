 ...
 ******************************************************** */
function fnList(){
    location.href = "<c:url value='/sys/code/DetailCodeList.do'/>";
}
/* ********************************************************
 * 수정화면으로  바로가기
 ******************************************************** */
function fnModify(){
    ...
    varForm.action           = "<c:url value='/sys/code/DetailCodeModify.do'/>";
...
function fnDelete(){
    if (confirm("<spring:message code='common.delete.msg'/>")) {
        var varForm              = document.all["Form"];
        varForm.action           = "<c:url value='/sys/code/DetailCodeRemove.do'/>";
        varForm.codeId.value     = "${result.codeId}";
        varForm.code.value       = "${result.code}";
        varForm.submit();
    }
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form name="Form" method="post" action="<c:url value='/sys/code/DetailCodeList.do'/>">
