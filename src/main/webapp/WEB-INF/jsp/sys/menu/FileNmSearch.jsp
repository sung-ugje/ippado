...
function linkPage(pageNo){
	...
	document.progrmManageForm.action = "<c:url value='/sys/menu/ProgramListSearch.do'/>";
...
<body> 
<form name="progrmManageForm" action ="<c:url value='/sys/menu/ProgramListSearch.do'/>" method="post">
