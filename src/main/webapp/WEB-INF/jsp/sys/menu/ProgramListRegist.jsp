...
function insertProgramListManage(form) {
    if(confirm("<spring:message code="common.save.msg" />")){
        if(!validateProgrmManageVO(form)){          
            ...
            form.action="<c:url value='/sys/menu/ProgramListRegist.do'/>";
            form.submit();
        }
    }
}
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form:form commandName="progrmManageVO"  action="/sys/menu/ProgramListRegist.do" method="post" >
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <tr> 
                          <td>
                            <a href="<c:url value='/sys/menu/ProgramListManageSelect.do'/>" onclick="selectList(); return false;"><spring:message code="button.list" /></a> 
                          </td>
                          <td width="10"></td>
                          <td>
