...
function fDeleteProgrmManageList() {
    ...
    document.progrmManageForm.action = "<c:url value='/sys/menu/ProgrmManageListDelete.do'/>";
...
//  document.menuManageForm.searchKeyword.value = 
    ...
    document.progrmManageForm.action = "<c:url value='/sys/menu/ProgramListManageSelect.do'/>";
    document.progrmManageForm.submit();
}
...
function insertProgramListManage() {
    document.progrmManageForm.action = "<c:url value='/sys/menu/ProgramListRegist.do'/>";
    document.progrmManageForm.submit(); 
}
/* ********************************************************
 * 상세조회처리 함수
...
function selectUpdtProgramListDetail(progrmFileNm) {
    ...
    document.progrmManageForm.action = "<c:url value='/sys/menu/ProgramListDetailSelectUpdt.do'/>";
    document.progrmManageForm.submit(); 
}
/* ********************************************************
 * focus 시작점 지정함수
...
<div id="wrap">
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            <!-- 현재위치 네비게이션 시작 -->
            <div id="content">
            <form name="progrmManageForm" action ="<c:url value='/sys/menu/ProgramListManageSelect.do'/>" method="post">
                    ...
                    <!-- loop 시작 -->                                
                      <tr>
					    ...
					    <td style="cursor:hand;" nowrap="nowrap">                                 
					            <span class="link"><a href="<c:url value='/sys/menu/ProgramListDetailSelectUpdt.do'/>?tmp_progrmNm=<c:out value="${result.progrmFileNm}"/>"  onclick="selectUpdtProgramListDetail('<c:out value="${result.progrmFileNm}"/>'); return false;"><c:out value="${result.progrmFileNm}"/></a></span>
					    </td>
