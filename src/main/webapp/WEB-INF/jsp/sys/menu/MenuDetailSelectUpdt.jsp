...
function updateMenuManage(form) {
    ...
    if(!validateMenuManageVO(form)){            
    	...
    	if(confirm("<spring:message code='common.save.msg' />")){
         form.action="<c:url value='/sys/menu/MenuDetailSelectUpdt.do'/>";
         form.submit();
    	}
    }
}
...
function deleteMenuManage(form) {
    if(confirm("<spring:message code='common.delete.msg' />")){
        form.action="<c:url value='/sys/menu/MenuManageDelete.do'/>";
        form.submit();
    }
}
/* ********************************************************
...
function searchFileNm() {
    ...
    window.open("<c:url value='/sys/menu/ProgramListSearch.do'/>",'','width=800,height=600');
}
/* ********************************************************
 * 목록조회 함수
 ******************************************************** */
function selectList(){
    location.href = "<c:url value='/sys/menu/MenuManageSelect.do'/>";
}
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form:form commandName="menuManageVO" name="menuManageVO" action ="<c:url value='/sys/menu/MenuDetailSelectUpdt.do' />" method="post">
                        ...
                        <table summary="메뉴상세정보">
                          ...
                          <tr> 
                            ...
                            <td width="85%" colspan="3" nowrap="nowrap">
                                ...
                                <a href="<c:url value='/sys/menu/ProgramListSearch.do'/>?tmp_SearchElementName=progrmFileNm" target="_blank" title="새창으로 이동" onclick="searchFileNm();return false;"  style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/img_search.gif' />"
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <tr> 
                          <td>
                            <a href="<c:url value='/sys/menu/MenuManageSelect.do'/>" onclick="selectList(); return false;">목록</a> 
                          </td>
                          <td width="10"></td>
                          <td>
