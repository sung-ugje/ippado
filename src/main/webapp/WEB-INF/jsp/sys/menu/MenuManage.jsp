...
function fDeleteMenuList() {
    ...
    document.menuManageForm.action = "<c:url value='/sys/menu/MenuManageListDelete.do'/>";
...
//  document.menuManageForm.searchKeyword.value = 
    ...
    document.menuManageForm.action = "<c:url value='/sys/menu/MenuManageSelect.do'/>";
    document.menuManageForm.submit();
}
...
function insertMenuManage() {
    document.menuManageForm.action = "<c:url value='/sys/menu/MenuRegistInsert.do'/>";
    document.menuManageForm.submit();   
}
 ...
 */
function bndeInsertMenuManage() {
    document.menuManageForm.action = "<c:url value='/sys/menu/MenuBndeRegist.do'/>";
    document.menuManageForm.submit();
} 
/* ********************************************************
 * 상세조회처리 함수
...
function selectUpdtMenuManageDetail(menuNo) {
    ...
    document.menuManageForm.action = "<c:url value='/sys/menu/MenuManageListDetailSelect.do'/>";
    document.menuManageForm.submit();   
}
/* ********************************************************
 * 최초조회 함수
...
<div id="wrap">
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            <!-- 현재위치 네비게이션 시작 -->
            <div id="content">
            <form name="menuManageForm" action ="<c:url value='/sys/menu/MenuManageSelect.do'/>" method="post">
