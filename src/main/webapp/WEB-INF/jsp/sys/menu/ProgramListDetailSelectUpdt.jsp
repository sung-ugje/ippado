...
function updateProgramListManage(form) {
    if(confirm("<spring:message code="common.save.msg" />")){
        if(!validateProgrmManageVO(form)){          
            ...
            form.action="<c:url value='/'/>sys/menu/ProgramListDetailSelectUpdt.do";
            form.submit();
        }
    }
}
...
function deleteProgramListManage(form) {
    if(confirm("<spring:message code="common.delete.msg" />")){
        form.action="<c:url value='/'/>sys/menu/ProgramListManageDelete.do";
        form.submit();
    }
}
 ...
 ******************************************************** */
function selectList(){
    location.href = "<c:url value='/'/>sys/menu/ProgramListManageSelect.do";
}
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form:form commandName="progrmManageVO" action="/sys/menu/ProgramListDetailSelectUpdt.do">
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <tr> 
                          ...
                          <td width="10"></td>
                          <td>
                            <a href="<c:url value='/sys/menu/ProgramListManageDelete.do'/>?progrmFileNm=<c:out value="${progrmManageVO.progrmFileNm  }"/>" onclick="deleteProgramListManage(document.getElementById('progrmManageVO')); return false;"><spring:message code="button.delete" /></a> 
                          </td>
                        </tr>
                        </table>
                    </div>
