...
function insertMenuManage(form) {
    if(!validateMenuManageVO(form)){            
    	...
    	if(confirm("<spring:message code="common.save.msg" />")){
         form.action="<c:url value='/sys/menu/MenuRegistInsert.do'/>";
         form.submit();
    	}
    }
}
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form:form commandName="menuManageVO" name="menuManageVO" method="post" action="${pageContext.request.contextPath}/sys/menu/MenuRegistInsert.do">
                        ...
                        <table summary="메뉴 등록화면">
						  ...
						  <tr> 
						    ...
						    <td width="85%"  colspan="3" nowrap="nowrap">
						        ...
						        <a href="<c:url value='/sys/menu/ProgramListSearch.do'/>?tmp_SearchElementName=progrmFileNm" target="_blank" title="새창으로" onclick="javascript:searchFileNm(); return false;" style="selector-dummy:expression(this.hideFocus=false);" >
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <tr> 
                          <td>
                            <a href="<c:url value='/sys/menu/MenuManageSelect.do'/>" onclick="javascript:selectList(); return false;">목록</a> 
                          </td>
                          <td width="10"></td>
                          <td>
