...
<!-- 행정안전부 로고 및 타이틀 시작 -->
<div id="logoarea">
	<h1><a href="<c:url value='/'/>sys/user/actionMain.do"><img src="<c:url value='/'/>images/header/logo_top.png" alt="서해도선" /></a></h1>
</div>
<div id="project_title"><span class="maintitle">편안하고 안전한 신나는 섬여행 </span><strong>궁평항 서해도선</strong>
